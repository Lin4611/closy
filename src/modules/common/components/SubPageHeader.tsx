 ...
 * sticky 為固定行為，不提供開關。
 */
export const SubPageHeader = ({ title, backHref, backLabel, rightSlot }: SubPageHeaderProps) => {
  return (
    <header className="sticky top-0 z-10 flex h-16 w-full items-center justify-between bg-neutral-100 px-4 py-2.5">
      <Link href={backHref} className="flex size-10 items-center justify-center" aria-label={backLabel}>
