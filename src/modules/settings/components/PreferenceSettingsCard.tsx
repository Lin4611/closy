...
export const PreferenceSettingCard = ({ defaultStyle, defaultColor }: PreferenceProps) => {
  return (
    <div className="flex flex-1 flex-col gap-3">
      ...
      <div className="flex flex-1 flex-col gap-5 rounded-[20px] bg-white p-4 shadow-[1px_1px_4px_rgba(0,0,0,0.1),inset_0_0_0_0.5px_rgba(50,18,51,0.24)] transition duration-300 ease-out">
        <SettingItemCard title="風格" href="/settings/styles" value={defaultStyle} />
        <SettingItemCard title="色系" href="/settings/colors" value={defaultColor} />
      </div>
    </div>
  )
}
